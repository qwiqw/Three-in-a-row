...
def three_in_a_row(old, new, level):
    ...
    if old[1] == 5:
        if (level[old[1]][old[0]] == level[old[1] - 1][old[0]] and
            ...
            symbol_old2 = random.choice(['.', '@', '#', '*'])
            symbol_old3 = random.choice(['.', '@', '#', '*'])
            symbol_level1 = level[old[1] - 5][old[0]]
    ...
    if old[1] == 1:
        if (level[old[1]][old[0]] == level[old[1] + 1][old[0]] and
                level[old[1]][old[0]] == level[old[1] - 1][old[0]]):
            symbol_old1 = random.choice(['.', '@', '#', '*'])
            symbol_old2 = random.choice(['.', '@', '#', '*'])
            symbol_old3 = random.choice(['.', '@', '#', '*'])
            level[old[1] - 1] = level[old[1] - 1][:old[0]] + symbol_old1 + level[old[1] - 1][old[0] + 1:]
            level[old[1]] = level[old[1]][:old[0]] + symbol_old2 + level[old[1]][old[0] + 1:]
            level[old[1] + 1] = level[old[1] + 1][:old[0]] + symbol_old3 + level[old[1] + 1][old[0] + 1:]
    if old[1] == 2:
        if (level[old[1]][old[0]] == level[old[1] + 1][old[0]] and
                level[old[1]][old[0]] == level[old[1] - 1][old[0]]):
            ...
            symbol_old2 = random.choice(['.', '@', '#', '*'])
            symbol_old3 = random.choice(['.', '@', '#', '*'])
            symbol_level1 = level[old[1] - 2][old[0]]
            level[old[1] - 2] = level[old[1] - 2][:old[0]] + symbol_old1 + level[old[1] - 2][old[0] + 1:]
            level[old[1] - 1] = level[old[1] - 1][:old[0]] + symbol_old2 + level[old[1] - 1][old[0] + 1:]
            level[old[1]] = level[old[1]][:old[0]] + symbol_old3 + level[old[1]][old[0] + 1:]
            level[old[1] + 1] = level[old[1] + 1][:old[0]] + symbol_level1 + level[old[1] + 1][old[0] + 1:]
    if old[1] == 3:
        if (level[old[1]][old[0]] == level[old[1] + 1][old[0]] and
                level[old[1]][old[0]] == level[old[1] - 1][old[0]]):
            symbol_old1 = random.choice(['.', '@', '#', '*'])
            ...
            symbol_old3 = random.choice(['.', '@', '#', '*'])
            symbol_level1 = level[old[1] - 2][old[0]]
            symbol_level2 = level[old[1] - 3][old[0]]
            level[old[1] - 3] = level[old[1] - 3][:old[0]] + symbol_old1 + level[old[1] - 3][old[0] + 1:]
            level[old[1] - 2] = level[old[1] - 2][:old[0]] + symbol_old2 + level[old[1] - 2][old[0] + 1:]
            level[old[1] - 1] = level[old[1] - 1][:old[0]] + symbol_old3 + level[old[1] - 1][old[0] + 1:]
            level[old[1]] = level[old[1]][:old[0]] + symbol_level2 + level[old[1]][old[0] + 1:]
            level[old[1] + 1] = level[old[1] + 1][:old[0]] + symbol_level1 + level[old[1] + 1][old[0] + 1:]
    if old[1] == 4:
        if (level[old[1]][old[0]] == level[old[1] + 1][old[0]] and
                level[old[1]][old[0]] == level[old[1] - 1][old[0]]):
            ...
            symbol_level2 = level[old[1] - 3][old[0]]
            symbol_level3 = level[old[1] - 4][old[0]]
            level[old[1] - 4] = level[old[1] - 4][:old[0]] + symbol_old1 + level[old[1] - 4][old[0] + 1:]
            level[old[1] - 3] = level[old[1] - 3][:old[0]] + symbol_old2 + level[old[1] - 3][old[0] + 1:]
            level[old[1] - 2] = level[old[1] - 2][:old[0]] + symbol_old3 + level[old[1] - 2][old[0] + 1:]
            level[old[1] - 1] = level[old[1] - 1][:old[0]] + symbol_level3 + level[old[1] - 1][old[0] + 1:]
            level[old[1]] = level[old[1]][:old[0]] + symbol_level2 + level[old[1]][old[0] + 1:]
            level[old[1] + 1] = level[old[1] + 1][:old[0]] + symbol_level1 + level[old[1] + 1][old[0] + 1:]
    if old[1] == 5:
        if (level[old[1]][old[0]] == level[old[1] + 1][old[0]] and
            ...
            symbol_level2 = level[old[1] - 3][old[0]]
            symbol_level3 = level[old[1] - 4][old[0]]
            symbol_level4 = level[old[1] - 5][old[0]]
            level[old[1] - 5] = level[old[1] - 5][:old[0]] + symbol_old1 + level[old[1] - 5][old[0] + 1:]
            level[old[1] - 4] = level[old[1] - 4][:old[0]] + symbol_old2 + level[old[1] - 4][old[0] + 1:]
            level[old[1] - 3] = level[old[1] - 3][:old[0]] + symbol_old3 + level[old[1] - 3][old[0] + 1:]
            level[old[1] - 2] = level[old[1] - 2][:old[0]] + symbol_level4 + level[old[1] - 2][old[0] + 1:]
            level[old[1] - 1] = level[old[1] - 1][:old[0]] + symbol_level3 + level[old[1] - 1][old[0] + 1:]
            level[old[1]] = level[old[1]][:old[0]] + symbol_level2 + level[old[1]][old[0] + 1:]
            level[old[1] + 1] = level[old[1] + 1][:old[0]] + symbol_level1 + level[old[1] + 1][old[0] + 1:]
    if old[1] == 6:
        if (level[old[1]][old[0]] == level[old[1] + 1][old[0]] and
            ...
            symbol_level3 = level[old[1] - 4][old[0]]
            symbol_level4 = level[old[1] - 5][old[0]]
            symbol_level5 = level[old[1] - 6][old[0]]
            level[old[1] - 6] = level[old[1] - 6][:old[0]] + symbol_old1 + level[old[1] - 6][old[0] + 1:]
            level[old[1] - 5] = level[old[1] - 5][:old[0]] + symbol_old2 + level[old[1] - 5][old[0] + 1:]
            level[old[1] - 4] = level[old[1] - 4][:old[0]] + symbol_old3 + level[old[1] - 4][old[0] + 1:]
            level[old[1] - 3] = level[old[1] - 3][:old[0]] + symbol_level5 + level[old[1] - 3][old[0] + 1:]
            level[old[1] - 2] = level[old[1] - 2][:old[0]] + symbol_level4 + level[old[1] - 2][old[0] + 1:]
            level[old[1] - 1] = level[old[1] - 1][:old[0]] + symbol_level3 + level[old[1] - 1][old[0] + 1:]
            level[old[1]] = level[old[1]][:old[0]] + symbol_level2 + level[old[1]][old[0] + 1:]
            level[old[1] + 1] = level[old[1] + 1][:old[0]] + symbol_level1 + level[old[1] + 1][old[0] + 1:]
    if old[1] == 7:
        if (level[old[1]][old[0]] == level[old[1] + 1][old[0]] and
            ...
            symbol_level4 = level[old[1] - 5][old[0]]
            symbol_level5 = level[old[1] - 6][old[0]]
            symbol_level6 = level[old[1] - 7][old[0]]
            level[old[1] - 7] = level[old[1] - 7][:old[0]] + symbol_old1 + level[old[1] - 7][old[0] + 1:]
            level[old[1] - 6] = level[old[1] - 6][:old[0]] + symbol_old2 + level[old[1] - 6][old[0] + 1:]
            level[old[1] - 5] = level[old[1] - 5][:old[0]] + symbol_old3 + level[old[1] - 5][old[0] + 1:]
            level[old[1] - 4] = level[old[1] - 4][:old[0]] + symbol_level6 + level[old[1] - 4][old[0] + 1:]
            level[old[1] - 3] = level[old[1] - 3][:old[0]] + symbol_level5 + level[old[1] - 3][old[0] + 1:]
            level[old[1] - 2] = level[old[1] - 2][:old[0]] + symbol_level4 + level[old[1] - 2][old[0] + 1:]
            level[old[1] - 1] = level[old[1] - 1][:old[0]] + symbol_level3 + level[old[1] - 1][old[0] + 1:]
            level[old[1]] = level[old[1]][:old[0]] + symbol_level2 + level[old[1]][old[0] + 1:]
    ...
    if old[1] == 4:
        if (level[old[1]][old[0]] == level[old[1] + 1][old[0]] and
            ...
            symbol_level2 = level[old[1] - 2][old[0]]
            symbol_level3 = level[old[1] - 3][old[0]]
            symbol_level4 = level[old[1] - 4][old[0]]
            level[old[1] - 4] = level[old[1] - 4][:old[0]] + symbol_old1 + level[old[1] - 4][old[0] + 1:]
            level[old[1] - 3] = level[old[1] - 3][:old[0]] + symbol_old2 + level[old[1] - 3][old[0] + 1:]
            level[old[1] - 2] = level[old[1] - 2][:old[0]] + symbol_old3 + level[old[1] - 2][old[0] + 1:]
            level[old[1] - 1] = level[old[1] - 1][:old[0]] + symbol_level4 + level[old[1] - 1][old[0] + 1:]
            level[old[1]] = level[old[1]][:old[0]] + symbol_level3 + level[old[1]][old[0] + 1:]
            level[old[1] + 1] = level[old[1] + 1][:old[0]] + symbol_level2 + level[old[1] + 1][old[0] + 1:]
            level[old[1] + 2] = level[old[1] + 2][:old[0]] + symbol_level1 + level[old[1] + 2][old[0] + 1:]
    if old[1] == 5:
        if (level[old[1]][old[0]] == level[old[1] + 1][old[0]] and
            ...
            symbol_level3 = level[old[1] - 3][old[0]]
            symbol_level4 = level[old[1] - 4][old[0]]
            symbol_level5 = level[old[1] - 5][old[0]]
            level[old[1] - 5] = level[old[1] - 5][:old[0]] + symbol_old1 + level[old[1] - 5][old[0] + 1:]
            level[old[1] - 4] = level[old[1] - 4][:old[0]] + symbol_old2 + level[old[1] - 4][old[0] + 1:]
            level[old[1] - 3] = level[old[1] - 3][:old[0]] + symbol_old3 + level[old[1] - 3][old[0] + 1:]
            level[old[1] - 2] = level[old[1] - 2][:old[0]] + symbol_level5 + level[old[1] - 2][old[0] + 1:]
            level[old[1] - 1] = level[old[1] - 1][:old[0]] + symbol_level4 + level[old[1] - 1][old[0] + 1:]
            level[old[1]] = level[old[1]][:old[0]] + symbol_level3 + level[old[1]][old[0] + 1:]
            level[old[1] + 1] = level[old[1] + 1][:old[0]] + symbol_level2 + level[old[1] + 1][old[0] + 1:]
            level[old[1] + 2] = level[old[1] + 2][:old[0]] + symbol_level1 + level[old[1] + 2][old[0] + 1:]
